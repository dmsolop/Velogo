...
class _$ProfileEntityImpl implements _ProfileEntity {
  ...
  @override
  String toString() {
    return 'ProfileEntity(id: $id, name: $name, email: $email, gender: $gender, age: $age, avatarUrl: $avatarUrl, fitnessLevel: $fitnessLevel, healthDataIntegration: $healthDataIntegration, syncStatus: $syncStatus, recentActivities: $recentActivities, totalRides: $totalRides, totalDistance: $totalDistance, totalTime: $totalTime, lastActivity: $lastActivity, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _ProfileEntity implements ProfileEntity {
  const factory _ProfileEntity(
      ...
      final DateTime? lastActivity,
      final DateTime? createdAt,
      final DateTime? updatedAt}) = _$ProfileEntityImpl;
