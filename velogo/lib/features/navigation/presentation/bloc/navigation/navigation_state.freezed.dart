...
abstract class $NavigationStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({NavigationTab selectedTab});
}
...
class _$NavigationStateImpl implements _NavigationState {
  const _$NavigationStateImpl({this.selectedTab = NavigationTab.home});
  ...
  @override
  String toString() {
    return 'NavigationState(selectedTab: $selectedTab)';
  }
...
abstract class _NavigationState implements NavigationState {
  const factory _NavigationState({final NavigationTab selectedTab}) =
